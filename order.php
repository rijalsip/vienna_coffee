...
<div class="col-lg-9 mt-2">
  <div class="card">
    ...
    <div class="card-body">
      <div class="row">
        <div class="col d-flex justify-content-end">
          <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModalTambahUser" title="Tambahkan User Baru">Tambah Order</button>
        </div>
      </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-2">
                    <div class="form-floating mb-3">
                      ...
                      <div class="invalid-feedback">Masukan Meja</div>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-7">
                    <div class="form-floating mb-3">
                      ...
                      <div class="invalid-feedback">masukan nama Pelanggan</div>
                    </div>
                  </div>
    ...
    ?>
        ...
        <!-- Modal Edit -->
        <div class="modal fade" id="ModalEdit<?php echo $row['id_order'] ?>" tabindex="-1" aria-labelledby="ModalEditLabel<?php echo $row['id_order'] ?>" aria-hidden="true">
          <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">

              <!-- Header -->
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="ModalEditLabel<?php echo $row['id_order'] ?>">Edit Data Orderan</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              ...
              <div class="modal-body">
                <form class="needs-validation" novalidate action="proses/proses_edit_order.php" method="POST">
                  <div class="row">
                    ...
                    <div class="col-lg-2">
                      <div class="form-floating mb-3">
                        <input type="number" class="form-control" id="meja" name="meja" placeholder="Nomor Meja" required value="<?php echo $row['meja'] ?>">
                        <label for="meja">Meja</label>
        ...
        <!-- Modal Delete -->
        <div class="modal fade" id="ModalDelete<?php echo $row['id_order'] ?>" tabindex="-1" aria-labelledby="#ModalViewLabel" aria-hidden="true">
          <div class="modal-dialog modal-md modal-fullscreen-md-down">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="ModalViewLabel">Hapus Orderan</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              ...
              <tr>
                ...
                <td>
                  ...
                  if (!empty($row['id_bayar'])) {
                    echo "<span class='badge text-bg-success'>Sudah Dibayar <i class='bi bi-check-all'></i></span>";
                  } else {
                    echo "<span class='badge text-bg-warning'>Belum Dibayar <i class='bi bi-clock'></i></span>";
                  }
                  ?>
                </td>
                ...
                <td>
                  <div class="d-flex">
                    <a class="btn btn-primary btn-sm me-1" href="./?x=orderitem&order=<?php echo $row['id_order'] . "&meja=" . $row['meja'] . "&pelanggan=" . $row['pelanggan'] ?>"><i class="bi bi-eye"></i></a>
                    <button class="<?php echo (!empty($row['id_bayar'])) ? "btn btn-secondary btn-sm me-1 disabled" : "btn btn-warning btn-sm me-1"; ?>" data-bs-toggle="modal" data-bs-target="#ModalEdit<?php echo $row['id_order'] ?>" title="Edit Data"><i class="bi bi-pencil-square"></i></button>
                    <button class="<?php echo (!empty($row['id_bayar'])) ? "btn btn-secondary btn-sm me-1 disabled" : "btn btn-danger btn-sm me-1"; ?>" data-bs-toggle="modal" data-bs-target="#ModalDelete<?php echo $row['id_order'] ?>" title="Hapus Data"><i class="bi bi-trash"></i></button>
                  </div>
                </td>
              </tr>
            <?php } ?>
